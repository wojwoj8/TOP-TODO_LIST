...
const Project = (name) => {
  ...
  const addTodo = (title, description, dueDate, priority, state) => {
    todo.push((0,_todos__WEBPACK_IMPORTED_MODULE_0__["default"])(title, description, dueDate, priority, state));
    console.log(todo);
    // console.log(x);
  };
...
function dateValidation() {
  try {
    ...
    const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dateElem.value), 'yyyy-MM-dd');
    return date;
  } catch (RangeError) {
...
function webInit() {
  ...
  (0,_project__WEBPACK_IMPORTED_MODULE_1__.renderProjects)();
  // loadStorage();
